    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-white">
        ...
        <div className="max-w-4xl mx-auto px-4 py-20 space-y-16">
            ...
            <section>
                ...
                <div className="space-y-4">
                    {[
                        ...
                        <div key={v} className="flex gap-4 p-5 bg-slate-50 rounded-2xl">
                            <span className="text-emerald-500 font-black text-lg mt-0.5">→</span>
                            <div><p className="font-bold text-slate-900">{v}</p><p className="text-slate-500 text-sm mt-1">{d}</p></div>
                        </div>
                    ))}
                </div>
            </section>
            ...
            <div className="flex gap-4">
                ...
                <Link to="/contact" className="px-6 py-3 border border-slate-200 text-slate-700 font-bold rounded-xl hover:bg-slate-50 transition-colors">Contact Us</Link>
            </div>
        </div>
    </div>
);
